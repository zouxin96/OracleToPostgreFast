...
namespace OracleToPostgreFastLibrary
{
    public class OracleToPostgreFastHelper
    {
...
"ZONE"
        ...
        /// 特殊替换文本
        /// </summary>
        static Dictionary<string, string> speWord = new Dictionary<string, string>()
            {
        ...
        public static string Exchange(string Text,bool cbAsStart, bool needZhuanyi,bool needwoshidanyinhao, bool isTest = false)
        {
            //单词缓存清空
            string tmpWord = "";
            //输入缓存 加个空格便于结尾处理
            ...
            ///结果缓存 
            string result = "";
            bool startFromAS = cbAsStart == true;
                    ...
                    if (tmpWord != "")
                    {
                        ...
                        if (AlreadyFindAS || startFromAS == false)
                        {
                            ...
                            foreach (string baoliuziItem in baoliuzi)
                            {
                                ...
                                if (baoliuziItem == tmpWord.ToUpper())
                                {
                            ...
                            if (double.TryParse(tmpWord, out a))
                            {
                                ...
                                isBaoliuzi = true;
                                if (needwoshidanyinhao)
                                {
                                    tmpWord = "我是单引号" + tmpWord + "我是单引号";
                                }
                                else {
                                    tmpWord = "'" + tmpWord + "'";
                                }
                            ...
                            //自带引号单词处理
                            if ((tmpWord[0] == '\"' && tmpWord[tmpWord.Length - 1] == '\"') || (tmpWord[0] == '\'' && tmpWord[tmpWord.Length - 1] == '\'')|| (tmpWord.StartsWith("我是单引号")  && tmpWord.EndsWith("我是单引号")) )
                            {
                                isBaoliuzi = true;
                            }
